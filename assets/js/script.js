...
var questions = [
  {
    ...
    choice1:
      'Adds any content between the parenthesis to the end of the specified array',
    choice2: 'Removes the last element of an array and returns that element',
    choice3:
      'Removes the first element from an array and returns that removed element',
    choice4:
      'Adds any content between the parenthesis to the start of the specified array',
    answer:
      'Adds any content between the parenthesis to the end of the specified array',
  },
  ...
  {
    questionText:
      'What are the components of .addEventListener and what order do they go in?',
...
function gameEnds() {
  ...
  playersFinalScoreDisplay.textContent =
